...
class UserProfile(UUIDModel, TimestampedModel):
    ...
    gender = models.CharField(max_length=20, blank=True, help_text="Gender")
    ...
    job_title = models.CharField(max_length=150, blank=True, help_text="Job title")
    ...
    social_links = models.JSONField(
        default=dict, blank=True, help_text="Social media links"
    )

    # Notifications
    notification_preferences = models.JSONField(
        default=dict, blank=True, help_text="Notification preferences"
    )

    # Privacy
    is_profile_public = models.BooleanField(
        default=False, help_text="Whether profile is publicly visible"
    )

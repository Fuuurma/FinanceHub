...
class WebSocketSessionManager:
    ...
    def register_connection(self, user_id: str, connection_id: str) -> bool:
        ...
        logger.info(f"User {user_id} connection registered. Total: {quota.current_connections}")
        return True
    ...
    def set_user_tier(self, user_id: str, tier: str):
        ...
        tier_limits = {
            'free': ConnectionQuota(max_connections=1, max_subscriptions=10, rate_limit_per_minute=30),
            'basic': ConnectionQuota(max_connections=3, max_subscriptions=50, rate_limit_per_minute=120),
            'pro': ConnectionQuota(max_connections=5, max_subscriptions=200, rate_limit_per_minute=300),
            'enterprise': ConnectionQuota(max_connections=10, max_subscriptions=1000, rate_limit_per_minute=1000)
        }
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        total_connections = sum(
            s.current_connections for s in self._sessions.values()
        )

                ...
                if crypto_type:
                    ...
                    if all_tickers:
                        ...
                        for ticker in all_tickers:
                            if ticker['symbol'].replace('USDT', '') in self.active_symbols:
                                updates.append({
    ...
    async def _broadcast_price_updates(self, updates: list):
        ...
        for update in updates:
            ...
            try:
                ...
                logger.debug(f"Broadcasted price update for {symbol}: {update.get('price')}")
...
if __name__ == "__main__":
    ...
    async def test():
        ...
        print("Starting price broadcaster test...")
        ...
        print(f"Final prices: {price_broadcaster.symbol_prices}")

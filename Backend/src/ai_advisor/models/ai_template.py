...
class AITemplate(UUIDModel, TimestampedModel):
    ...
    title = models.CharField(
        max_length=255,
        help_text="Template title for display"
    )
    ...
    version = models.IntegerField(
        default=1,
        help_text="Version number for cache busting"
    )
...
class UserAIReport(UUIDModel, TimestampedModel):
    ...
    version = models.IntegerField(
        default=1,
        help_text="Version for cache busting"
    )
    ...
    expires_at = models.DateTimeField(
        db_index=True,
        help_text="When this report expires"
    )
...
class AITemplateLog(UUIDModel, TimestampedModel):
    ...
    input_tokens = models.IntegerField(
        default=0,
        help_text="Tokens in prompt"
    )
    output_tokens = models.IntegerField(
        default=0,
        help_text="Tokens in response"
    )
...
class AIQueryLog(UUIDModel, TimestampedModel):
    ...
    query_text = models.TextField(
        help_text="User query or prompt"
    )

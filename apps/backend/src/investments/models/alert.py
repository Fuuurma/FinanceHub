...
class AlertHistory(UUIDModel, TimestampedModel):
...
class AlertNotification(UUIDModel, TimestampedModel):
    alert_history = models.ForeignKey(
        AlertHistory, on_delete=models.CASCADE, related_name="notifications"
    )
...
class AlertTemplate(UUIDModel, TimestampedModel):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="alert_templates"
    )

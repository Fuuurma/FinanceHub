...
MIDDLEWARE = [
    ...
    "core.middleware.rate_limit.RateLimitMiddleware",  # Custom rate limiting
...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("DB_USER", "financehub"),
        "PASSWORD": os.getenv("DB_PASSWORD", "financehub_dev_password"),

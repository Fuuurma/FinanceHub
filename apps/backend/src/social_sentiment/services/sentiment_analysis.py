...
class AggregatedSentiment:
    """Aggregate sentiment from multiple sources with weighted averaging."""
    ...
    def aggregate(
        ...
        return {
            ...
            "vader_compound": Decimal(str(round(vader_compound_sum, 4))),
            "textblob_polarity": Decimal(str(round(textblob_polarity_sum, 4))),
            "confidence": Decimal(str(round(confidence_sum, 4))),
            "post_count": n,

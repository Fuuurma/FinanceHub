    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "circulating_supply",
                    models.DecimalField(decimal_places=8, max_digits=30, null=True),
                ),
                (
                    "total_supply",
                    models.DecimalField(decimal_places=8, max_digits=30, null=True),
                ...
                (
                    "price_change_180d_pct",
                    models.DecimalField(decimal_places=4, max_digits=10, null=True),
                ),
                (
                    "volume_change_180d_pct",
                    models.DecimalField(decimal_places=4, max_digits=10, null=True),
                ),
                (
                    "price_change_1y",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rating",
                    models.CharField(
                        help_text="e.g. Overweight, Buy, Hold", max_length=50
                    ),
                ),
                (
                    "target_price",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "max_supply",
                    models.DecimalField(decimal_places=10, max_digits=40, null=True),
                ),
                (
                    "fdv",
                    models.DecimalField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="assets", to="assets.exchange"
            ),
        ),
        migrations.AddField(
            model_name="asset",
        ...
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["status", "ticker"], name="assets_status_097f43_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["asset_type", "market_cap"], name="assets_asset_t_619b53_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["last_price_updated_at"], name="assets_last_pr_aa1f3b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="corporate_actions_1",
                to="assets.asset",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name="assetpriceshistoric",
            index=models.Index(
                fields=["asset", "-date"], name="asset_price_asset_i_b9a2d3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="assetpriceshistoric",
        ...
        migrations.AddIndex(
            model_name="assetpriceshistoric",
            index=models.Index(
                fields=["source"], name="asset_price_source__6fb62b_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="assetpriceshistoric",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="asset_metri_asset_i_888032_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="assetmetricshistoric",

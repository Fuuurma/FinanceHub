...
FILTER_CATEGORIES = {
    'price': {
        'label': 'Price',
        'filters': ['price_min', 'price_max', 'change_percent_min', 'change_percent_max']
    },
    'volume': {
        'label': 'Volume',
        'filters': ['volume_min', 'volume_avg_min']
    },
    'fundamentals': {
        'label': 'Fundamentals',
        'filters': ['market_cap_min', 'market_cap_max', 'pe_min', 'pe_max', 'pb_min', 'pb_max', 'dividend_yield_min']
    },
    'technical': {
...
class StockScreener:
    ...
    def screen(self, limit: int = DEFAULT_RESULTS_LIMIT) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Screener completed: {len(filtered_assets)} results in {elapsed:.2f}s")
    ...
    def get_available_filters(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'presets': {k: {'name': v['name'], 'description': v['description']} for k, v in SCREENER_PRESETS.items()},
...
if __name__ == "__main__":
    ...
    print(f"Custom screener result: {result}")

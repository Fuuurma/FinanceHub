...
class CacheManager:
    ...
    async def _evict_l1(self):
        while len(self.l1_cache) >= self.l1_max_size or self._get_l1_size_bytes() >= self.l1_max_bytes:
    ...
    async def get(
        ...
        **kwargs
        ...
        try:
            from assets.models.asset_prices_historic import AssetPricesHistoric
            ...
            if prefix == "asset_price":
                ...
                if symbol:
                    ...
                    if record:
                        ...
                        await self._promote_to_l1(cache_key, value)
                        await self.set(prefix, *args, value=value, ttl=self.l3_default_ttl, **kwargs)
    ...
    async def warm_cache(
        self,
        warm_data: Dict[str, Tuple[Any, int]]
    ) -> int:
        warmed = 0
    ...
    async def get_statistics(self) -> dict:
        ...
        try:
            l2_info = django_cache._cache.info if hasattr(django_cache._cache, 'info') else {}
        except Exception:
            l2_info = {}
